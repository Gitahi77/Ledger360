    ...
    <div className="container mx-auto p-6 max-w-4xl" style={{ paddingTop: '2rem', paddingBottom: '6rem' }}>
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          with the Kenya Data Protection Act (DPA), 2019. We are registered as a Data Controller with the 
          Office of the Data Protection Commissioner (ODPC).
        </p>
      </section>

      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">2. Lawful Basis for Processing</h2>
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">3. AI Processing & Cross-Border Transfers</h2>
        <p className="mb-4">
      ...
      <section className="mb-8">
        <h2 className="text-xl font-semibold mb-4">5. Your Data Subject Rights</h2>
        <p className="mb-4">Under the Kenya DPA, you have the right to:</p>
        <ul className="list-disc pl-6 mb-4 space-y-2">
